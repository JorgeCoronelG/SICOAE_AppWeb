...
<div class="row justify-content-center">
    <div class="table-responsive">
        <table id="tabla-tutor" class="table table-bordered" cellspacing="0" width="100%">
...
<div class="modal fade" id="change-status-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Se cambiará el estatus de <strong><span id="tutor"></span></strong> a <strong><span id="status"></span></strong></div>        <div class="modal-footer">
